    ...
    where TLanguageService : AbstractLanguageService<TPackage, TLanguageService>
{
    ...
    protected override void RegisterInitializeAsyncWork(PackageLoadTasks packageInitializeTasks)
    {
        ...
        packageInitializeTasks.AddTask(isMainThreadTask: true, task: PackageInitializationMainThreadAsync);
    }

    private async Task PackageInitializationMainThreadAsync(PackageLoadTasks packageInitializeTasks, CancellationToken cancellationToken)
    {
        ...
        packageInitializeTasks.AddTask(
             ...
             task: (PackageLoadTasks packageInitializeTasks, CancellationToken cancellationToken) =>
             {
