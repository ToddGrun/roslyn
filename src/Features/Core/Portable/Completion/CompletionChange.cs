...
public sealed class CompletionChange
{
    ...
    /// </summary>
    public int? NewPosition { get => NewSelectionSpan?.End; }

    /// <summary>
    /// The new selection span after the change has been applied.
    /// If null then the new caret position will be determined by the completion host.
    /// </summary>
    internal TextSpan? NewSelectionSpan { get; }
    ...
    private CompletionChange(
        TextChange textChange, ImmutableArray<TextChange> textChanges, TextSpan? newSelectionSpan, bool includesCommitCharacter, ImmutableDictionary<string, string> properties)
    {
        TextChange = textChange;
        NewSelectionSpan = newSelectionSpan;
