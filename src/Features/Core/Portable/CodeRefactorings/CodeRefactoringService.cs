...
namespace Microsoft.CodeAnalysis.CodeRefactorings
{
    ...
    internal sealed class CodeRefactoringService : ICodeRefactoringService
    {
        ...
        public async Task<ImmutableArray<CodeRefactoring>> GetRefactoringsAsync(
            ...
            CancellationToken cancellationToken)
        {
            var telemetryPrioritySuffix = $" (Priority {(int)priority})";

            using (TelemetryHistogramLogger.LogBlockTimed(TelemetryPerfEventNames.CodeRefactoring, "Total" + telemetryPrioritySuffix))
                    ...
                    tasks.Add(Task.Run(() =>
                        {
                            ...
                            using (TelemetryHistogramLogger.LogBlockTimed(TelemetryPerfEventNames.CodeRefactoring, providerName + telemetryPrioritySuffix))
