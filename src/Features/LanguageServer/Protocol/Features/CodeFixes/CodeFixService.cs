...
namespace Microsoft.CodeAnalysis.CodeFixes
{
    ...
    internal partial class CodeFixService : ICodeFixService
    {
        ...
        {
            using var _ = TelemetryHistogramLogger.LogBlockTimed(TelemetryPerfEventNames.CodeFixes, "GetMostSevereFixAsync");
            ...
            TextDocument document, TextSpan range, string diagnosticId, DiagnosticSeverity minimumSeverity, CodeActionOptionsProvider fallbackOptions, CancellationToken cancellationToken)
        {
            ...
            using var _ = TelemetryHistogramLogger.LogBlockTimed(TelemetryPerfEventNames.CodeFixes, "GetDocumentFixAllForIdInSpanAsync");
            ImmutableArray<DiagnosticData> diagnostics;
            ...
            using (TelemetryHistogramLogger.LogBlockTimed(TelemetryPerfEventNames.CodeFixes, "StreamFixesAsync"))
            {
                await foreach (var collection in StreamFixesAsync(
