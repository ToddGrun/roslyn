...
[ExportLanguageService(typeof(IEmbeddedLanguageClassificationService), LanguageNames.VisualBasic), Shared]
[method: ImportingConstructor]
[method: Obsolete(MefConstruction.ImportingConstructorMessage, error: true)]
internal class VisualBasicEmbeddedLanguageClassificationService(
    ...
    : AbstractEmbeddedLanguageClassificationService(
        ...
        VisualBasicFallbackEmbeddedLanguageClassifier.Instance,
        classifiers)
{
}
