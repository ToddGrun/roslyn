...
";
            ...
            CompileAndVerify(source,
                             sourceSymbolValidator: delegate (ModuleSymbol m)
                             {
                                 ...
                                 var actualAMembers = ((SourceModuleSymbol)m).GlobalNamespace.GetTypeMembers("A1").Single().GetMembersAsImmutable().ToArray();
                                 ...
                                 var actualBMembers = ((SourceModuleSymbol)m).GlobalNamespace.GetTypeMembers("B").Single().GetMembersAsImmutable().ToArray();
                                 ...
                                 string[] expectedCMembers = {".cctor",
                                                            "C", "B", "F", "A",
                                                            ".ctor"};
                                 var actualCMembers = ((SourceModuleSymbol)m).GlobalNamespace.GetTypeMembers("C1").Single().GetMembersAsImmutable().ToArray();
                             ...
                             symbolValidator: delegate (ModuleSymbol m)
                             {
                                 ...
                                 var actualAMembers = m.GlobalNamespace.GetTypeMembers("A1").Single().GetMembersAsImmutable().ToArray();
                                 ...
                                 var actualBMembers = m.GlobalNamespace.GetTypeMembers("B").Single().GetMembersAsImmutable().ToArray();

                                 AssertEx.SetEqual(expectedBMembers, actualBMembers.Select(s => s.Name));

                                 string[] expectedCMembers = { "C", "B", "A", ".ctor", "F" };
                                 var actualCMembers = m.GlobalNamespace.GetTypeMembers("C1").Single().GetMembersAsImmutable().ToArray();
