...
";
            ...
            //IL
            var classA = (NamedTypeSymbol)global.GetTypeMembersAsImmutable("CustomModifierOverridingA").Single();
            var classB = (NamedTypeSymbol)global.GetTypeMembersAsImmutable("CustomModifierOverridingB").Single();
            var classC = (NamedTypeSymbol)global.GetTypeMembersAsImmutable("CustomModifierOverridingC").Single();
            var classD = (NamedTypeSymbol)global.GetTypeMembersAsImmutable("CustomModifierOverridingD").Single();
            ...
            //Source
            var classE = (NamedTypeSymbol)global.GetTypeMembersAsImmutable("CustomModifierOverridingE").Single();
