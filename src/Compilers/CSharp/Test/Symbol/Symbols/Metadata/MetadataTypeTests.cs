...
namespace Microsoft.CodeAnalysis.CSharp.UnitTests
{
    public class MetadataTypeTests : CSharpTestBase
    {
        ...
        public void MetadataNamespaceSymbol01()
        {
            ...
            var ns = ns2.GetMembersAsImmutable("Serialization").Single() as NamespaceSymbol;
            ...
            Assert.Equal(48, ns.GetMembersAsImmutable().Length);
            Assert.Equal(47, ns.GetTypeMembersAsImmutable().Length);
        ...
        public void MetadataTypeSymbolClass01()
        {
            ...
            // 18 members
            Assert.Equal(18, class1.GetMembersAsImmutable().Length);
            Assert.Equal(0, class1.GetTypeMembersAsImmutable().Length);
        ...
        public void MetadataTypeSymbolGenClass02()
        {
            ...
            var type1 = ns2.GetTypeMembersAsImmutable("Dictionary").First() as NamedTypeSymbol;
            ...
            Assert.Equal(67, type1.GetMembersAsImmutable().Length);
            Assert.Equal(3, type1.GetTypeMembersAsImmutable().Length);
        ...
        public void MetadataTypeSymbolGenInterface01()
        {
            ...
            var type1 = ns2.GetTypeMembersAsImmutable("IList").First() as NamedTypeSymbol;
            ...
            Assert.Equal(6, type1.GetMembersAsImmutable().Length);
            Assert.Equal(0, type1.GetTypeMembersAsImmutable().Length);
        ...
        public void MetadataTypeSymbolStruct01()
        {
            ...
            var ns1 = mscorNS.GlobalNamespace.GetMembersAsImmutable("System").Single() as NamespaceSymbol;
            var ns2 = ns1.GetMembersAsImmutable("Runtime").Single() as NamespaceSymbol;
            var ns3 = ns2.GetMembersAsImmutable("Serialization").Single() as NamespaceSymbol;
            var type1 = ns3.GetTypeMembersAsImmutable("StreamingContext").First() as NamedTypeSymbol;
            ...
            Assert.Equal(11, type1.GetMembersAsImmutable().Length);
            Assert.Equal(0, type1.GetTypeMembersAsImmutable().Length);
...
";
            ...
            var ns1 = systemCoreNS.GlobalNamespace.GetMembersAsImmutable("System").Single() as NamespaceSymbol;
            var ns2 = ns1.GetMembersAsImmutable("Diagnostics").Single() as NamespaceSymbol;
            var ns3 = ns2.GetMembersAsImmutable("Eventing").Single() as NamespaceSymbol;

            var type1 = ns3.GetTypeMembersAsImmutable("EventProviderBase").Single() as NamedTypeSymbol;
            // EventData[]
            var type2 = (type1.GetMembersAsImmutable("m_eventData").Single() as FieldSymbol).Type as ArrayTypeSymbol;
            var member2 = type1.GetMembersAsImmutable("WriteTransferEventHelper").Single() as MethodSymbol;
            ...
            Assert.Equal(0, type2.GetMembersAsImmutable().Length);
            Assert.Equal(0, type3.GetMembersAsImmutable(String.Empty).Length);

            Assert.Equal(0, type3.GetTypeMembersAsImmutable().Length);
            Assert.Equal(0, type2.GetTypeMembersAsImmutable(String.Empty).Length);
            Assert.Equal(0, type3.GetTypeMembersAsImmutable(String.Empty, 0).Length);
...
";
            ...
            var stateMachineClass = comp.GlobalNamespace.GetMember<NamedTypeSymbol>("C").GetMembersAsImmutable().OfType<NamedTypeSymbol>().Single();
  ...
  .class public H
  {
    .method public hidebysig specialname rtspecialname instance void .ctor() { ret }
        ...
        private static void GetAllNamespaceNames(ArrayBuilder<string> builder, NamespaceSymbol @namespace)
        {
            ...
            foreach (var member in @namespace.GetMembersAsImmutable())
            {
