...
namespace Microsoft.CodeAnalysis.CSharp.UnitTests.Symbols.Metadata.PE
{
    public class TypeKindTests : CSharpTestBase
    {
        ...
        private void TestTypeKindHelper(AssemblySymbol assembly)
        {
            ...
            var int32 = (from t in system.GetTypeMembersAsImmutable()
                         where t.Name.Equals("Int32")
                         select t).Single();

            Assert.Equal(TypeKind.Struct, int32.TypeKind);

            var func = (from t in system.GetTypeMembersAsImmutable()
            ...
            var ienumerable = (from t in collections.GetTypeMembersAsImmutable()
            ...
            var typeCode = (from t in system.GetTypeMembersAsImmutable()
            ...
            var console = system.GetTypeMembersAsImmutable("Console").Single();
