...
namespace Microsoft.CodeAnalysis.CSharp.UnitTests.Symbols.Metadata.PE
{
    public class NoPiaLocalHideAndTypeSubstitutionTests : CSharpTestBase
    {
        ...
        public void NoPiaTypeEquivalenceBetweenPIATypeInExternalAndLocalAssembly()
        {
            ...
            var canonicalType1 = localConsumerRefsAsm.First(arg => arg.Name == "Pia1").GlobalNamespace.GetTypeMembersAsImmutable("I1").Single();
            var canonicalType2 = localConsumerRefsAsm.First(arg => arg.Name == "Pia1").GlobalNamespace.GetMembersAsImmutable("NS1").OfType<NamespaceSymbol>().Single().GetTypeMembersAsImmutable("I2").Single();

            NamedTypeSymbol classLocalType = localConsumerRefsAsm.First(arg => arg.Name == "LocalTypes1").GlobalNamespace.GetTypeMembersAsImmutable("LocalTypes1").Single();
            MethodSymbol methodSymbol = classLocalType.GetMembersAsImmutable("Test1").OfType<MethodSymbol>().Single();
            ...
            var localTypeSource2 = @"public static class LocalType1
{
    public void Test1(External1.MyFunc arg)
    {
            ...
            NamedTypeSymbol classLocalType = localConsumer.GlobalNamespace.GetTypeMembersAsImmutable("LocalType1").Single();
...
";
            ...
            var canonicalType = localConsumerRefsAsm.First(arg => arg.Name == "GeneralPia").GlobalNamespace.GetTypeMembersAsImmutable("FooStruct").Single();

            NamedTypeSymbol classLocalType = localConsumer.GlobalNamespace.GetTypeMembersAsImmutable("TypeSubstitution").Single();
            FieldSymbol localFieldSymbol = classLocalType.GetMembersAsImmutable("myOwnVar").OfType<FieldSymbol>().Single();

            NamedTypeSymbol classRefLocalType = localConsumerRefsAsm.First(arg => arg.Name == "ExternalAsm1").GlobalNamespace.GetTypeMembersAsImmutable("ExternalAsm1").Single();
            MethodSymbol refMethodSymbol = classRefLocalType.GetMembersAsImmutable("Scen1").OfType<MethodSymbol>().Single();
...
static class TypeSubstitution
{
    ...
    public static void Main()
    {
        ...
        ExternalAsm1.Scen2(myOwnRef);
            ...
            var canonicalTypeInter = canonicalType.GetTypeMembersAsImmutable("IBase").Single();

            NamedTypeSymbol classLocalType = localConsumer.GlobalNamespace.GetTypeMembersAsImmutable("TypeSubstitution").Single();
            FieldSymbol localFieldSymbol = classLocalType.GetMembersAsImmutable("myOwnRef").OfType<FieldSymbol>().Single();

            NamedTypeSymbol classRefLocalType = localConsumerRefsAsm.First(arg => arg.Name == "ExternalAsm1").GlobalNamespace.GetTypeMembersAsImmutable("ExternalAsm1").Single();
            MethodSymbol refMethodSymbol = classRefLocalType.GetMembersAsImmutable("Scen2").OfType<MethodSymbol>().Single();
            ImmutableArray<ParameterSymbol> param = refMethodSymbol.Parameters;
            ...
            var localTypeSource = @"static class TypeSubstitution
{
    ...
    public static void Main()
    {
       ...
       myLocalType = ExternalAsm1.Scen3(5);
            ...
            var localConsumerRefsAsm = localConsumer.Assembly.GetNoPiaResolutionAssemblies();
            var canonicalType = localConsumerRefsAsm.First(arg => arg.Name == "GeneralPia").GlobalNamespace.GetTypeMembersAsImmutable("FooEnum").Single();

            NamedTypeSymbol classLocalType = localConsumer.GlobalNamespace.GetTypeMembersAsImmutable("TypeSubstitution").Single();
            FieldSymbol localFieldSymbol = classLocalType.GetMembersAsImmutable("myLocalType").OfType<FieldSymbol>().Single();

            NamedTypeSymbol classRefLocalType = localConsumerRefsAsm.First(arg => arg.Name == "ExternalAsm1").GlobalNamespace.GetTypeMembersAsImmutable("ExternalAsm1").Single();
            MethodSymbol methodSymbol = classRefLocalType.GetMembersAsImmutable("Scen3").OfType<MethodSymbol>().Single();
            ...
            var localTypeSource = @"static class TypeSubstitution
{
    ISubFuncProp myLocalType = ExternalAsm1.Scen4;
            ...
            var localConsumerRefsAsm = localConsumer.Assembly.GetNoPiaResolutionAssemblies();
            var canonicalType = localConsumerRefsAsm.First(arg => arg.Name == "GeneralPia").GlobalNamespace.GetTypeMembersAsImmutable("ISubFuncProp").Single();

            NamedTypeSymbol classLocalType = localConsumer.GlobalNamespace.GetTypeMembersAsImmutable("TypeSubstitution").Single();
            FieldSymbol localFieldSymbol = classLocalType.GetMembersAsImmutable("myLocalType").OfType<FieldSymbol>().Single();

            NamedTypeSymbol classRefLocalType = localConsumerRefsAsm.First(arg => arg.Name == "ExternalAsm1").GlobalNamespace.GetTypeMembersAsImmutable("ExternalAsm1").Single();
            var methodSymbol = classRefLocalType.GetMembersAsImmutable("Scen4").OfType<PropertySymbol>().Single();
            ...
            var localTypeSource = @"static class TypeSubstitution
{
    GeneralEventScenario.EventHandler myLocalType = ExternalAsm1.Scen5;
            ...
            var canonicalTypeInter = canonicalType.GetTypeMembersAsImmutable("EventHandler").Single();

            NamedTypeSymbol classLocalType = localConsumer.GlobalNamespace.GetTypeMembersAsImmutable("TypeSubstitution").Single();
            FieldSymbol localFieldSymbol = classLocalType.GetMembersAsImmutable("myLocalType").OfType<FieldSymbol>().Single();

            NamedTypeSymbol classRefLocalType = localConsumerRefsAsm.First(arg => arg.Name == "ExternalAsm1").GlobalNamespace.GetTypeMembersAsImmutable("ExternalAsm1").Single();
            var methodSymbol = classRefLocalType.GetMembersAsImmutable("Scen5").OfType<PropertySymbol>().Single();
        ...
        public void NoPIATypeSubstitutionForClassThatImplementNoPiaInterface()
        {
            ...
            NamedTypeSymbol classRefLocalType = localConsumerRefsAsm.First(arg => arg.Name == "ExternalAsm1").GlobalNamespace.GetTypeMembersAsImmutable("SubFuncProp").Single();
            MethodSymbol methodSymbol = classRefLocalType.GetMembersAsImmutable("Foo").OfType<MethodSymbol>().Single();
        ...
        public void NoPiaAmbiguousCanonicalTypeSymbolForStruct()
        {
            ...
            Assert.Same(localConsumerRefsAsm.First(arg => arg.Name == "GeneralPia").GlobalNamespace.ChildNamespace("InheritanceConflict").GetTypeMembersAsImmutable("IBase").Single(), ambiguous.FirstCandidate);
            Assert.Same(localConsumerRefsAsm.First(arg => arg.Name == "GeneralPiaCopy").GlobalNamespace.ChildNamespace("InheritanceConflict").GetTypeMembersAsImmutable("IBase").Single(), ambiguous.SecondCandidate);
        }
            ...
            var localTypeSource2 = @"public class IdentifyingAttributes
{
    ...
    public IInterface Foo()
    {
        return new IInterface();
            ...
            var importedType = localConsumerRefsAsm.First(arg => arg.Name == "Dummy2").GlobalNamespace.GetTypeMembersAsImmutable("IdentifyingAttributes").Single();
            var methodSymbol = importedType.GetMembersAsImmutable("Foo").OfType<MethodSymbol>().Single();
...
public interface I1
{
            ...
            var localConsumerRefsAsm = localConsumer.Assembly.GetNoPiaResolutionAssemblies();
            var importedTypeComp2 = localConsumerRefsAsm.First(arg => arg.Name == "Dummy1").GlobalNamespace.GetTypeMembersAsImmutable("LocalTypes1").Single();
            var embeddedType = importedTypeComp2.GetMembersAsImmutable("Test1").OfType<MethodSymbol>().Single();
            var importedTypeAsm = localConsumerRefsAsm.First(arg => arg.Name == "Pia1").GlobalNamespace.GetTypeMembersAsImmutable("I1").Single();
