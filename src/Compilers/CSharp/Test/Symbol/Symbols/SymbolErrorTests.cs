...
";
            ...
            var classA = comp.SourceModule.GlobalNamespace.GetTypeMembersAsImmutable("A").Single() as NamedTypeSymbol;
            ...
            var text = @"namespace NS
{
    ...
    public class A : Goo {}
            ...
            var ns = comp.SourceModule.GlobalNamespace.GetMembersAsImmutable("NS").Single() as NamespaceSymbol;
            var baseType = ns.GetTypeMembersAsImmutable("A").Single().BaseType();
            Assert.Equal("Goo", baseType.Name);
            Assert.Equal(TypeKind.Error, baseType.TypeKind);
            Assert.Null(baseType.BaseType());

            var type2 = ns.GetTypeMembersAsImmutable("Bar").Single() as NamedTypeSymbol;
            ...
            var type3 = ns.GetTypeMembersAsImmutable("S").Single() as NamedTypeSymbol;
...
";
            ...
            var ns = comp.SourceModule.GlobalNamespace.GetMembersAsImmutable("NS").Single() as NamespaceSymbol;
            var baseType = (NamedTypeSymbol)ns.GetTypeMembersAsImmutable("A").Single().BaseType();
            Assert.Null(baseType.BaseType());
            Assert.Equal("B", baseType.Name);
            Assert.Equal(TypeKind.Error, baseType.TypeKind);

            baseType = (NamedTypeSymbol)ns.GetTypeMembersAsImmutable("DD").Single().BaseType();
            Assert.Null(baseType.BaseType());
            Assert.Equal("BB", baseType.Name);
            Assert.Equal(TypeKind.Error, baseType.TypeKind);

            baseType = (NamedTypeSymbol)ns.GetTypeMembersAsImmutable("BB").Single().BaseType();
            Assert.Null(baseType.BaseType());
...
";
            ...
            var ns = comp.SourceModule.GlobalNamespace.GetTypeMembersAsImmutable("A").Single() as NamedTypeSymbol;
            // TODO...
        }
  ...
  struct S
  {
     ...
     private NoType M() {
        return null;
            ...
            var ns = comp.SourceModule.GlobalNamespace.GetMembersAsImmutable("NS").Single() as NamespaceSymbol;
            var type1 = ns.GetTypeMembersAsImmutable("IGoo").Single() as NamedTypeSymbol;
            // bug: expected 1 but error symbol
            // Assert.Equal(1, type1.Interfaces().Count());

            var type2 = ns.GetTypeMembersAsImmutable("IBar").Single() as NamedTypeSymbol;
            ...
            var type3 = ns.GetTypeMembersAsImmutable("A").Single() as NamedTypeSymbol;
            ...
            var type4 = ns.GetTypeMembersAsImmutable("S").Single() as NamedTypeSymbol;
            ...
            var text = @"namespace NS
{
    ...
    partial class C : B2
    {
            ...
            var ns = comp.SourceModule.GlobalNamespace.GetMembersAsImmutable("NS").Single() as NamespaceSymbol;
            var type1 = ns.GetTypeMembersAsImmutable("C").Single() as NamedTypeSymbol;
            ...
            var text = @"namespace NS
{
    public partial class MyClass
    {
        ...
        partial void F<T, U>(T tt) where T : class {}
            ...
            var ns = comp.SourceModule.GlobalNamespace.GetMembersAsImmutable("NS").Single() as NamespaceSymbol;
            var type1 = ns.GetTypeMembersAsImmutable("MyClass").Single() as NamedTypeSymbol;
...
";
            ...
            Assert.Equal(1, comp.Assembly.Modules[1].GlobalNamespace.GetTypeMembersAsImmutable("<ModuleA01>f__AnonymousType0", 1).Length);
            Assert.Equal(1, comp.Assembly.Modules[2].GlobalNamespace.GetTypeMembersAsImmutable("<ModuleB01>f__AnonymousType0", 1).Length);
...
class A {
    public B n;
            ...
            var classA = (NamedTypeSymbol)comp.GlobalNamespace.GetTypeMembersAsImmutable("A").Single();
...
class A : C {
    public B n;
            ...
            CSharpCompilation comp = CreateCompilation(text);
            var classA = (NamedTypeSymbol)comp.GlobalNamespace.GetTypeMembersAsImmutable("A").Single();
            var classC = (NamedTypeSymbol)comp.GlobalNamespace.GetTypeMembersAsImmutable("C").Single();
            var classB = (NamedTypeSymbol)classC.GetTypeMembersAsImmutable("B").Single();
            var fieldSym = (FieldSymbol)classA.GetMembersAsImmutable("n").Single();
...
class A : C {
    public B n;
            ...
            var classBinN1 = (NamedTypeSymbol)ns1.GetTypeMembersAsImmutable("B").Single();
            var classBinN2 = (NamedTypeSymbol)ns2.GetTypeMembersAsImmutable("B").Single();
            var fieldSym = (FieldSymbol)classA.GetMembersAsImmutable("n").Single();
            var fieldType = fieldSym.Type;
...
class Derived : Base<NotFound>{}";
            ...
            var derived = comp.SourceModule.GlobalNamespace.GetTypeMembersAsImmutable("Derived").Single();
