...
";
            ...
            var loopResult = Parallel.ForEach(compilation.GlobalNamespace.GetTypeMembersAsImmutable(), type =>
...
";
            ...
            NamedTypeSymbol type01 = comp.SourceModule.GlobalNamespace.GetTypeMembersAsImmutable("Test").Single();
...
";
            ...
            Assert.True(((TypeSymbol)compilation.GlobalNamespace.GetTypeMembersAsImmutable("C").Single()).GetMembersAsImmutable().Any(x => x.IsIndexer()));
