...
";
            ...
            var ms = comp.GlobalNamespace.GetTypeMembersAsImmutable("Program").Single().GetMembersAsImmutable("M").OfType<MethodSymbol>();
...
";
            ...
            var m = comp.GlobalNamespace.GetTypeMembersAsImmutable("Program").Single().GetMembersAsImmutable("M").Single();
