...
@"interface I
{
    ...
    void F2(System.UIntPtr x, nuint y);
        ...
        private static void VerifyTypes(NamedTypeSymbol underlyingType, NamedTypeSymbol nativeIntegerType, bool signed)
        {
            ...
            VerifyInterfaces(underlyingType, underlyingType.GetDeclaredInterfacesAsImmutable(null), nativeIntegerType, nativeIntegerType.GetDeclaredInterfacesAsImmutable(null));
        ...
        {
            Assert.Empty(nativeIntegerType.GetTypeMembersAsImmutable());
