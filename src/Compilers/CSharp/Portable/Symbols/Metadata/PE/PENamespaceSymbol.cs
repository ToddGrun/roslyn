...
namespace Microsoft.CodeAnalysis.CSharp.Symbols.Metadata.PE
{
    ...
    internal abstract class PENamespaceSymbol
        : NamespaceSymbol
    {
        private static readonly InlineDictionary<ReadOnlyMemory<char>, PENestedNamespaceSymbol> s_emptyNamespaces = new(ReadOnlyMemoryOfCharComparer.Instance);
        private static readonly InlineDictionary<ReadOnlyMemory<char>, ImmutableArray<PENamedTypeSymbol>> s_emptyTypes = new(ReadOnlyMemoryOfCharComparer.Instance);
